 ...
 * @author GermanSR
 */
public abstract class CanvasPane2D extends StackPane{
    ...
    public CanvasPane2D(){  
        ...
        scene = new SubScene(rootNode, 0, 0);
        ...
        rootNode.getChildren().add(pointlight);
